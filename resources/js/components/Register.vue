	...
	<div class="form">
		<form @submit.prevent="submit" class="form__login">
			...
			<div class="form__login--row">
				...
				/>
				<div v-if="errors && errors.name" class="error">{{ errors.name[0] }}</div>
			</div>
			<div class="form__login--row">
			...
			<div class="form__login--row">
				...
				/>
				<div v-if="errors && errors.email" class="error">{{ errors.email[0] }}</div>
			</div>
			<div class="form__login--row">
			...
			<div class="form__login--row">
				...
				/>
				<div v-if="errors && errors.password" class="error">{{ errors.password[0] }}</div>
			</div>
			<div class="form__login--row">
			...
			<div class="form__login--row">
				...
				/>
				<div v-if="errors && errors.confirmPassword" class="error">{{ errors.confirmPassword[0] }}</div>
			</div>
			<div class="form__login--row">
